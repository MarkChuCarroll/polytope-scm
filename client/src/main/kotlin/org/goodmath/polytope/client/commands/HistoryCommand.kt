...
class HistoryGetCommand: PolytopeCommandBase("get", "get a history") {
    private val project: String? by option("--project", help="the project containing the histories")
    private val username: String? by option("--user", help = "The userId of the user performing the command")
    private val historyName: String by option("--history", help="The name of the history to get").required()
    private val serverUrl: String? by option("--server", help = "The URL of the polytope server")
    private val format: String by option("--format", help="The output format").choice("text", "json")
        .default("text")
    ...
    override fun run() {
        handleCommandErrors("history", "get") {
            ...
            val project = project ?: ws?.project ?: throw PtException(PtException.Kind.UserError,
...
class HistoryCreateCommand: PolytopeCommandBase("create", "create a new history") {
    private val project: String? by option("--project", help="the project that should contain the history")
    private val sourceHistory: String? by option("--from-history", help="the history that the new history will branch from")
    private val index: Int? by option("--from-history-version", help="The history version to branch from.").int()
    private val description: String by option("--description", help="a description for the new branch").required()
    ...
    override fun run() {
        handleCommandErrors("history", "create") {
            val ws = loadWorkspace()
            val hi = sourceHistory ?: ws?.history ?: throw PtException(PtException.Kind.UserError,
                "you must either provide a source history or run this command in a workspace")
            val pr = project ?: ws?.project ?:throw PtException(PtException.Kind.UserError,
...
class HistoryListCommand: PolytopeCommandBase("list", "list histories") {
    private val project: String? by option("--project", help="the project containing the histories")
    private val username: String? by option("--user", help = "The userId of the user performing the command")
    private val serverUrl: String? by option("--server", help = "The URL of the polytope server")
    private val format: String by option("--format", help="The output format").choice("text", "json")
...
class HistoryStepsCommand: PolytopeCommandBase("steps", "list versions of a history") {
    private val project by option("--project", help="the project containing the history")
    private val history by option("--history", help="the name of the history")
    private val username: String? by option("--user", help = "The userId of the user performing the command")
    private val serverUrl: String? by option("--server", help = "The URL of the polytope server")
    private val format: String by option("--format", help="The output format").choice("text", "json")
        .default("text")
    override fun run() {
        handleCommandErrors("history", "steps") {
            ...
            val pr = project ?: ws?.project ?: throw PtException(PtException.Kind.UserError,
                "you must either supply a project parameter, or run this command in a workspace")
            val hi = history ?: ws?.history ?: throw PtException(PtException.Kind.UserError,
...
class HistoryOpenCommand : PolytopeCommandBase("open", "open a history for a workspace") {
