...
data class BaselineConflict(
    ...
    companion object {
        fun decodeFromString(details: String): BaselineConflict {
            return ParsingCommons.klaxon.parse(details)!!
        }
...
object BaselineAgent: Agent<Baseline> {
    ...
    override fun merge(
        ...
        return MergeResult(
            ...
            sourceVersion = source.id,
            targetVersion = target.id,
            proposedMerge = encodeToString(
                Baseline(targetBaseline.rootDir,
