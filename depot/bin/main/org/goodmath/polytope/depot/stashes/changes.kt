...
class ChangeStash(
     ...
     * @return the change
     */
    fun retrieveChange(auth: AuthenticatedUser, project: String, id: Id<Change>): Change {
    ...
    private fun getChangeId(project: String, history: String, changeName: String): Id<Change> {
        val idx = getCollectionIndex()
        return idx.entries[ChangeIndexKey(project, history, changeName)] ?: throw PtException(
            PtException.Kind.NotFound,
