...
import org.goodmath.polytope.depot.util.ID_CHANGE_SAVE
import org.goodmath.polytope.depot.util.ID_PROJECT
...
class ProjectVersionSpecifierTest {
    ...
    fun testParseProjectVersionSpecifier() {
        ...
        val three = ProjectVersionSpecifier.fromString("change(pr@hist@thisone)")
        assertEquals(ProjectVersionSpecifier.change(ID_PROJECT, "hist", "thisone"), three)
