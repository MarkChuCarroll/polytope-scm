...
from polytope.common.api.user import UserCreateRequest, UserUpdateKind, UserUpdateRequest
            ...
            match modify_user.kind:
                ...
                case UserUpdateKind.Grant:
                    ...
                    if perms is None:
                        raise PtException(
                            ErrorKind.UserError,
                            "Grant user permissions request does not include a permitted actions list",
                        )
                ...
                case UserUpdateKind.Revoke:
                    ...
                    if perms is None:
                        raise PtException(
                            ErrorKind.UserError,
                            "Revoke user permissions request does not include a permitted actions list",
                        )
