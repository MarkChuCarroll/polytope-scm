...
def with_auth[R, **P](f: Callable[Concatenate[R, AuthenticatedUser, Request, Response, P], None]) -> Callable[Concatenate[R, Request, Response, P], None]:
    """
    ...
    def inner(self: R, req: Request, resp: Response, *args: P.args, **kw: P.kwargs) -> None:
