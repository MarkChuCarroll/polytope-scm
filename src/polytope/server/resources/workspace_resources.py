...
class WorkspaceActionResource(PtResource):
    ...
    def on_get_paths(self, auth: AuthenticatedUser, project: str, ws_id: Id[Workspace]) -> JDict:
    ...
    def on_post(
        ...
        match body["type"]:
            ...
            case "WsAddFileReq":
                ...
                resp.status = falcon.HTTP_OK
            case "WsResetReq":
                res_req = WsResetReq.from_dict(body)
                raise NotImplementedError(f"WsResetReq not implemented yet {res_req}")
